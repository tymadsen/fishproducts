  ...
  <div class="col-sm-9">
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>1/2 x 3.75 stainless</td>
            <td>10,690</td>
            <td>9780</td>
          </tr>
          <tr class="active">
            <td colspan="3">Petzl</td>
          </tr>
          <tr>
            <td>Long Life</td>
            <td>2500 k</td>
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <tr>
            <td>Metolius Rap Hanger</td>
            <td>5000 lb</td>
            <td>smooth radius rap hanger</td>
          </tr>
          <tr>
            <td>Fixe Hanger</td>
            <td>40 kn</td>
            <td>general use hanger</td>
          </tr>
          <tr>
            <td>Fixe Rap Ring</td>
            <td>3400 lb (Stainless Steel)</td>
            <td>anchor station lower-off</td>
          </tr>
          <tr>
            <td>SMC Rap Ring</td>
            <td>3400 lb (Aluminum)</td>
            <td>anchor station lower-off</td>
          </tr>
          <tr>
            <td>FISH Anchor Clips</td>
            <td>8000 lb (24,000 breaking)</td>
            <td>anchor station lower-off</td>
          </tr>
          <tr>
            <td>Ushba Bolt Hanger</td>
            <td>15 kn (Titanium)</td>
            <td>lightweight hanger</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <p>
      For an article on bolts, bolting, hangers and a bunch of good info, check this page out: <a href="http://www.dtek.chalmers.se/Climbing/Hardware/howtobolt.html" target="_blank">http://www.dtek.chalmers.se/Climbing/Hardware/howtobolt.html</a>
    </p>
  </div>
</div>
