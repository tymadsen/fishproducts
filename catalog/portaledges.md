...
<center>
    ...
    <a href="{{ "/pics/ed_mesca.jpg" | prepend: site.baseurl }}" target="_blank">
    ...
    <strong>
        <font size="+1"><b> 
          <a href="{{ "/pics/zodiac_oli.jpg" | prepend: site.baseurl }}" target="_blank"><img src="{{ "/pics/zodiac_oliTN.jpg" | prepend: site.baseurl }}" width="150" height="220" hspace="5" vspace="5" border="2"></a> 
          </b>
        </font>
    </strong>
    </font>
    ...
    <a href="{{ "/faqs/portaledges" | prepend: site.baseurl }}" target="_blank">
        <strong>
...
<p>
    ...
    <br>This feature packed ledge is the best choice for any Big Wall hopeful. Our super stable ledge was designed around <a href="{{ "/pics/corner.jpeg" | prepend: site.baseurl }}">machined 
...
<p align="right"><b><img src="{{ "/pics/new.gif" | prepend: site.baseurl }}" width="51" height="37" align="LEFT" border="0" naturalsizeflag="0"><a href="{{ "/pics/superduty_corner.jpg" | prepend: site.baseurl }}" target="_blank"><img src="{{ "/pics/superdutyTN.jpg" | prepend: site.baseurl }}" width="200" height="164" hspace="5" vspace="5" border="2" align="right"></a>New! 
...
<p align="left">
    ...
    <a href="{{ "/pics/onstimbo.jpeg" | prepend: site.baseurl }}">
...
<p align="left"><b><a href="{{ "/pics/econo.jpg" | prepend: site.baseurl }}" target="_blank"><img src="{{ "/pics/econoTN.jpg" | prepend: site.baseurl }}" width="150" height="200" hspace="5" vspace="5" align="right"></a>FISH 
        ECONOLEDGE<br>
...
<center>
    <b><font size="+1">We normally do not sell the rainflys separately. 
          ...
          replacement. Check our <a href="{{ "/catalog/repairs" | prepend: site.baseurl }}" target="_top">Repairs</a> 
...
<center>
    <a href="{{ "/faqs/portaledge" | prepend: site.baseurl }}" target="_blank">
        <strong>
            <img src="{{ "/pics/faqbar.jpeg" | prepend: site.baseurl }}" width="77" height="33" hspace="5" vspace="5" border="2" align="MIDDLE" naturalsizeflag="3">
        </strong>
    </a>
